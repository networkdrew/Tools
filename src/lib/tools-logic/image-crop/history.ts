/**
 * Generic bounded undo/redo stack over full-value snapshots — used here for
 * the crop/rotate/flip edit state (not the export settings like format or
 * quality, which aren't part of the undo timeline).
 */
